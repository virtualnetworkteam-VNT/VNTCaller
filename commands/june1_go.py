...
req=urllib.request.Request("https://api.github.com/repos/virtualnetworkteam-VNT/VNTCaller/contents/assets/june1_master.py",headers={"Authorization":"Bearer "+GH})
