...
req=urllib.request.Request("https://api.github.com/repos/virtualnetworkteam-VNT/VNTCaller/contents/assets/brain_phase1.py",headers={"Authorization":"Bearer "+GH})
