...
req=urllib.request.Request("https://api.github.com/repos/virtualnetworkteam-VNT/VNTCaller/contents/assets/verify_brain.py",headers={"Authorization":"Bearer "+GH})
