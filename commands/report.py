...
req=urllib.request.Request("https://api.github.com/repos/virtualnetworkteam-VNT/VNTCaller/contents/assets/report_state.py",headers={"Authorization":"Bearer "+GH})
